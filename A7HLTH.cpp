// A multimap_view osztály template, ami meglévő std::map-ek unióját egy
// multimap-pé láttatja. A map-ek független módon élhetik a saját életüket, de a
// nézeten keresztül is megváltozhatnak.
